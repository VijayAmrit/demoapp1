		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CustomersList",
									"targetURL": "#zasparcustomerdemoapp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zasparcustomerdemoapp1-display": {
								"semanticObject": "zasparcustomerdemoapp1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=za.spar.customer.demoapp1",
									"url": sap.ui.require.toUrl("za/spar/customer/demoapp1")
								}
							}
						}
					}
